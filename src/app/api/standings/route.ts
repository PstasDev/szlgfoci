...
export async function GET() {
  try {
    console.log('🔄 Next.js API Route: Fetching standings from Django backend...');
    
    const response = await fetch(`${DJANGO_API_BASE}/standings`, {
      method: 'GET',
      headers: {
    ...
    console.log('✅ Successfully fetched standings from Django:', data);
